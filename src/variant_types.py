...
def parse_int(_ty, string: str) -> tuple[str, int | None]:
...
def parse_float(_ty, string: str) -> tuple[str, float | None]:
...
def parse_bool(_ty, string: str) -> tuple[str, bool | None]:
...
def parse_literal(ty, string: str) -> tuple[str, str | None]:
